...
Usage:
    ...
    python pre-analysis/catalog/generate_docs.py --deployment data_test --format html
    python pre-analysis/catalog/generate_docs.py --deployment data_test --format both
"""
import argparse
import csv
import re
...
def main():
    ...
    parser.add_argument("--deployment", required=True, help="e.g. data_test")
