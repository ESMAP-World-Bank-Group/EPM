...
************************************IAEA************************
pDemandShed(c,q,d,t,y)
pCostDemandShed(z,y)
pH2Costs(z,y)                            'Electrolyzer related CAPEX and OPEX'
*************************************Dispatch****************************
pPlantDispatch2(c,q,d,t,y,g)                        'Detailed hourly dispatch by plant in MW'
pFuelDispatch(c,q,d,t,y,f)                          'Detailed Dispatch by fuel'
pCurtailedVRET(c,q,d,t,y)                           'Hourly VRE curtailment in MW'
pDemandTotalP(c,q,d,t,y)                            'Hourly demand in MW'
pStorLevel(c,q,d,t,y)                               'Level of storage (?W)'
pStorInj(c,q,d,t,y)                                 'Storage injection (MW)'
pStorOut(c,q,d,t,y)                                 'Storage output (MW)'
pStorLevelG(c,q,d,t,g,y)                               'Level of storage (?W)'
pStorInjG(c,q,d,t,g,y)                                 'Storage injection (MW)'
pStorOutG(c,q,d,t,g,y)                                 'Storage output (MW)'
pUnmetP(c,q,d,t,y)                                  'Unmet demand (MW)'

pOn(c,q,d,t,AT,y,g)                                      "On Off decisions"
pStUp(c,q,d,t,AT,y,g)                                    "Start Up decisions"
pShDn(c,q,d,t,AT,y,g)                                    "Shut  Dn decisions"
pHoursOn(c,q,d,y,g)                                 "Hours On"
pStUpCostG(c,q,d,t,y,g)                          'Start Up Costs per Gen'
pSpinReserves(c,q,d,t,y,g)                              "Operating reserves"

pH2PwrInT(c,q,d,t,y)                          'Total Power injected for H2 production (MW)'
...
***************Dispatch
pPlantDispatch2(c,q,d,t,y,g)$(FD(q,d,t)$pRunDispatch)                  =sum((zcmap(z,c),gzmap(g,z),gfmap(g,f)),vPwrOut.l(g,f,q,d,t,y))     +1e-6;
pDemandTotalP(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                      =sum(zcmap(z,c),pDemandData(z,q,d,y,t))                             +1e-6;
pFuelDispatch(c,q,d,t,y,f)$(FD(q,d,t)$pRunDispatch)                    =sum((zcmap(z,c),gfmap(g,f)),vPwrOut.l(g,f,q,d,t,y))                +1e-6;
pUnmetP(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                            =sum(zcmap(z,c),vUSE.l(z,q,d,t,y))                                  +1e-6;
pStorLevel(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                         =sum((zcmap(z,c),gzmap(st,z)),vStorage.l(st,q,d,t,y))               +1e-6;
pStorInj(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                           =sum((zcmap(z,c),gzmap(st,z)),vStorInj.l(st,q,d,t,y))               +1e-6;
pStorOut(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                           =sum((zcmap(z,c),gzmap(st,z),gfmap(st,f)),vPwrOut.l(st,f,q,d,t,y))  +1e-6;
pCurtailedVRET(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                     =sum(gzmap(VRE,z),vCurtailedVRE.l(z,VRE,q,d,t,y))                   +1e-6;

pStorLevelG(c,q,d,t,st,y)$(FD(q,d,t)$pRunDispatch)                     =sum((zcmap(z,c)),vStorage.l(st,q,d,t,y))$(pRunDispatch)                          +1e-6;
pStorInjG(c,q,d,t,st,y)$(FD(q,d,t)$pRunDispatch)                       =sum((zcmap(z,c)),vStorInj.l(st,q,d,t,y))$(pRunDispatch)                          +1e-6;
pStorOutG(c,q,d,t,st,y)$(FD(q,d,t)$pRunDispatch)                       =sum((zcmap(z,c),gfmap(st,f)),vPwrOut.l(st,f,q,d,t,y))$(pRunDispatch)             +1e-6;
pH2PwrInT(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                          =sum((zcmap(z,c),h2zmap(hh,z)),vH2PwrIn.l(hh,q,d,t,y))$pIncludeH2                 +1e-6;



pCostDemandShed(z,y)                                                   =vCostDemandShed.l(z,y)                                             +1e-6;
pDemandShed(c,q,d,t,y)$(FD(q,d,t)$pRunDispatch)                        =sum(zcmap(z,c),vDemandShed.l(z,q,d,t,y))                            +1e-6;
pSpinReserves(c,q,d,t,y,g)$(pzonal_spinning_reserve_constraints or psystem_spinning_reserve_constraints and pIncludeMinGenCon and MinGenPoint(g) and pRunDispatch and FD(q,d,t)$pRunDispatch)                    =sum((zcmap(z,c),gzmap(g,z)),vSpinningReserve.l(g,q,d,t,y))  +1e-6;
pStUpCostG(c,q,d,t,y,g)$(pIncludeMinGenCon and MinGenPoint(g) and pRunDispatch and FD(q,d,t))        =sum((zcmap(z,c),gzmap(g,z)),vStUpCost.l(g,q,d,t,y))  +1e-6;

pOn(c,q,d,t,AT,y,g)$mapTS(q,d,t,AT)                              =(sum((zcmap(z,c),mapTS(q,d,t,AT)),vOn.l(g,q,d,t,AT,y))  +0.000000001)$(pRunDispatch   and  pIncludeMinGenCon and  pGenData(g,"MinGenPoint") AND mapTS(q,d,t,AT));       
pStUp(c,q,d,t,AT,y,g)$mapTS(q,d,t,AT)                            =(sum((zcmap(z,c),mapTS(q,d,t,AT)),vStUp.l(g,q,d,t,AT,y))+0.000000001)$(pRunDispatch   and  pIncludeMinGenCon and  pGenData(g,"MinGenPoint")AND mapTS(q,d,t,AT)) ;       
pShDn(c,q,d,t,AT,y,g)$mapTS(q,d,t,AT)                            =(sum((zcmap(z,c),mapTS(q,d,t,AT)),vShDn.l(g,q,d,t,AT,y))+0.000000001)$(pRunDispatch   and  pIncludeMinGenCon and  pGenData(g,"MinGenPoint")AND mapTS(q,d,t,AT)) ;        
...
pAnncapex(z,y) = 1e6*sum(gzmap(ndc,z),               pCRF(ndc)*vCap.l(ndc,y)*pGenData(ndc,"Capex"))
               ...
               +     sum(gzmap(dc,z),                vAnnCapex.l(dc,y))+1e-5 ;
**************************H2 model addition**************************************************************
**********IAEA ONLY DEACTIVATE BELOW AND CREATE NEW PARAMETERS TO SEPARATE
*               +     sum(h2zmap(dch2,z),                vAnnCapexH2.l(dch2,y))$pIncludeH2
*               +1e6*sum(h2zmap(ndcH2,z),              pCRFH2(ndcH2)*vCapH2.l(ndcH2,y)*pH2Data(ndcH2,"Capex"))$pIncludeH2 +1e-5 ;
...
pFOM(z,y) = sum(gzmap(g,z),  vCap.l(g,y)*pGenData(g,"FOMperMW"))
          ...
          + sum(gzmap(cs,z), vCapTherm.l(cs,y)*pCSPData(cs,"Thermal field","FixedOM"))+1e-5 ;
**********IAEA ONLY DEACTIVATE BELOW AND CREATE NEW PARAMETERS TO SEPARATE

**************************H2 model addition**************************************************************
*          + sum(h2zmap(hh,z),  vCapH2.l(hh,y)*pH2Data(hh,"FOMperMW"))$pIncludeH2 +1e-5 ;


pSpinResCosts(z,y) = vYearlySpinningReserveCost.l(z,y) +1e-5 ;
...
pVOM(z,y) = sum((q,d,t), pHours(q,d,y,t)*(
                         ...
                         + sum((gzmap(cs,z),gfmap(cs,f)), pCSPData(cs,"Thermal Field","VOM")*vPwrOut.l(cs,f,q,d,t,y)))) +1e-5 ;
**************************H2 model addition**************************************************************
**********IAEA ONLY DEACTIVATE BELOW AND CREATE NEW PARAMETERS TO SEPARATE

***(units for equation below)**********       $/mMBTU_H2          mmBTU_H2/MWh_e        MW_e
*                        + sum((h2zmap(hh,z)), pH2Data(hh,"VOM")*pH2Data(hh,"Heatrate")*vH2PwrIn.l(hh,q,d,t,y))$pIncludeH2)) +1e-5 ;


pH2Costs(z,y)= sum((q,d,t), pHours(q,d,y,t)*(sum((h2zmap(hh,z)), pH2Data(hh,"VOM")*pH2Data(hh,"Heatrate")*vH2PwrIn.l(hh,q,d,t,y))))$pIncludeH2 
+ sum(gzmap(cs,z), vCapTherm.l(cs,y)*pCSPData(cs,"Thermal field","FixedOM"))$pIncludeH2
             +     sum(h2zmap(dch2,z),                vAnnCapexH2.l(dch2,y))$pIncludeH2
               +1e6*sum(h2zmap(ndcH2,z),              pCRFH2(ndcH2)*vCapH2.l(ndcH2,y)*pH2Data(ndcH2,"Capex"))$pIncludeH2 +1e-5 ;

pFuelCostsZone(z,y) = sum((gzmap(g,z),gfmap(g,f),zcmap(z,c),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t)*pFuelPrice(c,f,y)*pHeatRate(g,f)) +1e-5 ;


pImportCosts(z,y) = sum((zext,q,d,t), vImportPrice.l(z,zext,q,d,t,y)*pTradePrice(zext,q,d,y,t)*pHours(q,d,y,t)) +1e-5 ;

pExportRevenue(z,y) = sum((zext,q,d,t), vExportPrice.l(z,zext,q,d,t,y)*pTradePrice(zext,q,d,y,t)*pHours(q,d,y,t)) +1e-5 ;

pNewTransmissionCosts(z,y) = vYearlyTransmissionAdditions.l(z,y) +1e-5 ;
pUSECosts(z,y) = vYearlyUSECost.l(z,y) +1e-5 ;
pCO2backstopCosts(c,y) = vYearlyCO2backstop.l(c,y)*pCostOfCO2backstop +1e-5 ;
pSurplusCosts(z,y) = vYearlySurplus.l(z,y) +1e-5 ;
pVRECurtailment(z,y) = vYearlyCurtailmentCost.l(z,y) +1e-5 ;
        

* country level
pCountryPlanReserveCosts(c,y) = vUnmetPlanningReserveCountry.l(c,y)*pPlanningReserveVoLL +1e-5 ;
pUSRLocCosts(c,y) = sum((q,d,t), vUnmetSpinningReserveCountry.l(c,q,d,t,y)*pHours(q,d,y,t)*pSpinningReserveVoLL) +1e-5 ;

* System level
pUSRSysCosts(y) = sum((q,d,t), vUnmetSpinningReserveSystem.l(q,d,t,y)*pHours(q,d,y,t)*pSpinningReserveVoLL) +1e-5 ;
pUPRSysCosts(y) = vUnmetPlanningReserveSystem.l(y)*pPlanningReserveVoLL +1e-5 ;
...
pCostSummary(z,"Capex: $m"                    ,y) = pCapex(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Annualized capex: $m"         ,y) = pAnncapex(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Fixed O&M: $m"                ,y) = pFOM(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Variable O&M: $m"             ,y) = pVOM(z,y)/1e6 +1e-5 ;

pCostSummary(z,"Total fuel Costs: $m"         ,y) = pFuelCostsZone(z,y)/1e6 +1e-5 ;

pCostSummary(z,"Transmission additions: $m"   ,y) = pNewTransmissionCosts(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Spinning Reserve costs: $m"   ,y) = pSpinResCosts(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Unmet demand costs: $m"       ,y) = pUSECosts(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Excess generation: $m"        ,y) = pSurplusCosts(z,y)/1e6 +1e-5 ;
pCostSummary(z,"VRE curtailment: $m"          ,y) = pVRECurtailment(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Import costs: $m"             ,y) = pImportCosts(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Export revenue: $m"           ,y) = pExportRevenue(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Demand Response: $m"          ,y) = pCostDemandShed(z,y)/1e6 +1e-5 ;
pCostSummary(z,"Ann CAPEX and variable costs electrolyzers: $m"         ,y) = pH2Costs(z,y)/1e6 +1e-5 ;
...
pCostSummaryCountry(c,"Country Spinning Reserve violation: $m",y) = pUSRLocCosts(c,y)/1e6 +1e-5 ;
pCostSummaryCountry(c,"Country Planning Reserve violation: $m",y) = pCountryPlanReserveCosts(c,y)/1e6 +1e-5 ;
pCostSummaryCountry(c,"Total CO2 backstop cost by Country: $m",y) = pCO2backstopCosts(c,y)/1e6  +1e-5 ;
...
pCostSummaryCountry(c,"Total Annual Cost by Country: $m"      ,y) = sum(zcmap(z,c), pCostSummary(z,"Total Annual Cost by Zone: $m",y))
                                                                  ...
                                                                  + pCO2backstopCosts(c,y))/1e6  +1e-5 ;

                                                      


*--- Cost Summary Weighted by zone
pCostSummaryWeighted(z,sumhdr,y) = pWeightYear(y)*pCostSummary(z,sumhdr,y) +1e-5 ;
...
pCostSummaryWeighted(z,"Total Annual Cost by Zone: $m",y) = pWeightYear(y)*(pAnncapex(z,y) + pNewTransmissionCosts(z,y) + pFOM(z,y) + pVOM(z,y)
                                                                          ...
                                                                          + pVRECurtailment(z,y) + pSurplusCosts(z,y) + pSpinResCosts(z,y))/1e6 +1e-5 ;
...
* By zone
pFuelCosts(z,f,y) = sum((gzmap(g,z),gfmap(g,f),zcmap(z,c),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t)*pFuelPrice(c,f,y)*pHeatRate(g,f))/1e6 +1e-5 ;
pFuelConsumption(z,f,y) = vFuel.l(z,f,y)/1e6 +1e-5 ;

* By country
pFuelCostsCountry(c,f,y) = sum(zcmap(z,c), pFuelCosts(z,f,y)) +1e-5 ;
pFuelConsumptionCountry(c,f,y) = sum(zcmap(z,c), pFuelConsumption(z,f,y)) +1e-5 ;
...
pEnergyByFuel(z,f,y) = sum((gzmap(g,z),gfmap(g,f),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-5 ;
pEnergyByFuelCountry(c,f,y) = sum(zcmap(z,c), pEnergyByFuel(z,f,y)) +1e-5 ;
pEnergyByTechandFuel(z,tech,f,y) = sum((gzmap(g,z),gtechmap(g,tech),gfmap(g,f),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-5 ;
pEnergyByTechandFuelCountry(c,tech,f,y) = sum(zcmap(z,c), pEnergyByTechandFuel(z,tech,f,y)) +1e-5 ;

pEnergyMix(c,f,y) = pEnergyByFuelCountry(c,f,y)/(sum(f2, pEnergyByFuelCountry(c,f2,y)) + 1e-5);

pEnergyByPlant(zgmap(z,g),y) = sum((gfmap(g,f),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e3+1e-6;
...
* By zone
pDemandSupply(z,"Demand: GWh"            ,y) = sum((q,d,t), pDemandData(z,q,d,y,t)*pHours(q,d,y,t)*pEnergyEfficiencyFactor(z,y))/1e3 +1e-6 ;
*********************************************************H2 model addition****************************************************************
...
pDemandSupply(z,"Total production: GWh"  ,y) = sum(gzmap(g,z), pEnergyByPlant(z,g,y)) +1e-6;
pDemandSupply(z,"Unmet demand: GWh"      ,y) = sum((q,d,t), vUSE.l(z,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;
pDemandSupply(z,"Surplus generation: GWh",y) = sum((q,d,t), vSurplus.l(z,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;

pDemandSupply(z,"Imports exchange: GWh"     ,y) = (sum((sTopology(z,z2),q,d,t), vFlow.l(z2,z,q,d,t,y)*pHours(q,d,y,t)) + sum((zext,q,d,t), vImportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;
pDemandSupply(z,"Exports exchange: GWh"     ,y) = (sum((sTopology(z,z2),q,d,t), vFlow.l(z,z2,q,d,t,y)*pHours(q,d,y,t)) + sum((zext,q,d,t), vExportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;
pDemandSupply(z,"Net interchange: GWh"      ,y) = pDemandSupply(z,"Imports exchange: GWh",y) - pDemandSupply(z,"Exports exchange: GWh",y) +1e-6;
pDemandSupply(z,"Net interchange Ratio: GWh",y)$pDemandSupply(z,"Demand: GWh",y) = pDemandSupply(z,"Net interchange: GWh",y)/pDemandSupply(z,"Demand: GWh",y) +1e-6;
...
* By Country
pDemandSupplyCountry(c,"Demand: GWh"            ,y) = sum(zcmap(z,c), pDemandSupply(z,"Demand: GWh"            ,y)) +1e-6;
*********************************************************H2 model addition****************************************************************
...
pDemandSupplyCountry(c,"Total production: GWh"  ,y) = sum(zcmap(z,c), pDemandSupply(z,"Total production: GWh"  ,y)) +1e-6;
pDemandSupplyCountry(c,"Unmet demand: GWh"      ,y) = sum(zcmap(z,c), pDemandSupply(z,"Unmet demand: GWh"      ,y)) +1e-6;
pDemandSupplyCountry(c,"Surplus generation: GWh",y) = sum(zcmap(z,c), pDemandSupply(z,"Surplus generation: GWh",y)) +1e-6;

pDemandSupplyCountry(c,"Imports exchange: GWh"     ,y) = (sum((zcmap(z,c),sMapNCZ(z2,z),q,d,t), vFlow.l(z2,z,q,d,t,y)*pHours(q,d,y,t)) + sum((zcmap(z,c),zext,q,d,t), vImportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;
pDemandSupplyCountry(c,"Exports exchange: GWh"     ,y) = (sum((zcmap(z,c),sMapNCZ(z,z2),q,d,t), vFlow.l(z,z2,q,d,t,y)*pHours(q,d,y,t)) + sum((zcmap(z,c),zext,q,d,t), vExportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;
...
pDemandSupplyCountry(c,"Net interchange Ratio: GWh",y)$pDemandSupplyCountry(c,"Demand: GWh",y) = pDemandSupplyCountry(c,"Net interchange: GWh",y)/pDemandSupplyCountry(c,"Demand: GWh",y) +1e-6;
...
*--- Summary of results
pSummary("NPV of system cost: $m"          ) = vNPVCost.l/1e6 +1e-6;
pSummary("Total Generation: GWh"           ) = sum((gzmap(g,z),y), pWeightYear(y)*pEnergyByPlant(z,g,y)) +1e-6;
pSummary("Total Demand: GWh"               ) = sum((z,y), pWeightYear(y)*pDemandSupply(z,"Demand: GWh",y)) +1e-6;
pSummary("Total Capacity Added: MW"        ) = sum((g,y), vBuild.l(g,y)) +1e-6;
pSummary("Total Investment: $m"            ) = sum((g,y)$(ndc(g)), vBuild.l(g,y)*pGenData(g,"Capex")+ vBuildStor.l(g,y)*(pStorData(g,"Capex")+pCSPData(g,"Storage","Capex"))/1e3+vBuildTherm.l(g,y)*pCSPData(g,"Thermal Field","Capex")) + sum((g,y)$(dc(g)), vBuild.l(g,y)*pGenData(g,"Capex")*pCapexTrajectories(g,y)+(vBuildStor.l(g,y)*(pStorData(g,"Capex")+pCSPData(g,"Storage","Capex"))/1e3+vBuildTherm.l(g,y)*pCSPData(g,"Thermal Field","Capex"))*pCapexTrajectories(g,y)) +1e-6;
pSummary("Total USE: GWh"                  ) = sum((z,y), pWeightYear(y)*pDemandSupply(z,"Unmet demand: GWh",y)) +1e-6;
pSummary("Carbon costs: $m"                ) = sum((z,y), pWeightYear(y)*pRR(y)*vYearlyCarbonCost.l(z,y))/1e6 +1e-6;
pSummary("Trade costs: $m"                 ) = sum((z,y), pWeightYear(y)*pRR(y)*vYearlyTradeCost.l( z,y))/1e6 +1e-6;
pSummary("VRE curtailment: $m"             ) = sum((z,y), pWeightYear(y)*pRR(y)*pVRECurtailment(z,y))/1e6 +1e-6;
pSummary("Total Emission: mt"              ) = sum((z,y), pWeightYear(y)*vZonalEmissions.l(z,y))/1e6 +1e-6;
pSummary("Climate backstop cost: $m"       ) = sum((c,y), pWeightYear(y)*pRR(y)*vYearlyCO2backstop.l(c,y)*pCostOfCO2backstop)/1e6+sum(y, pWeightYear(y)*pRR(y)*pCostOfCO2backstop*vYearlySysCO2backstop.l(y))/1e6 +1e-6;

pSummary("Sys Spin Reserve violation: $m"  ) = sum(y, pWeightYear(y)*pRR(y)*pUSRSysCosts(y))/1e6 +1e-6;
pSummary("Sys Plan Reserve violation: $m"  ) = sum(y, pWeightYear(y)*pRR(y)*pUPRSysCosts(y))/1e6 +1e-6;
pSummary("Zonal Spin Reserve violation: $m") = sum((c,y), pWeightYear(y)*pRR(y)*pUSRLocCosts(c,y))/1e6 +1e-6;
pSummary("Zonal Plan Reserve violation: $m") = sum((c,y), pWeightYear(y)*pRR(y)*pCountryPlanReserveCosts(c,y))/1e6 +1e-6;
pSummary("Excess Generation Costs: $m"     ) = sum((z,y), pWeightYear(y)*pRR(y)*eYearlySurplusCost.l(z,y))/1e6 +1e-6;                                      
pSummary("Spinning reserve costs: $m"      ) = sum((z,y), pWeightYear(y)*pRR(y)*pSpinResCosts(z,y))/1e6 +1e-6;
...
* By zone
pInterchange(sTopology(z,z2),y) = sum((q,d,t), vFlow.l(z,z2,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;
...
pLossesTransmission(z,y) = sum((sTopology(z,z2),q,d,t), vFlow.l(z2,z,q,d,t,y)*pLossFactor(z,z2,y)*pHours(q,d,y,t)) +1e-6;
...
pAveragePrice(z,y)$pDemandSupply(z,"Demand: GWh",y) = 1e-3*sum((q,d,t),pPrice(z,q,d,t,y)*pDemandData(z,q,d,y,t)*pHours(q,d,y,t)*pEnergyEfficiencyFactor(z,y))
                                                     /pDemandSupply(z,"Demand: GWh",y)  +1e-6;
...
* By Zone
pPeakCapacity(z,"Available capacity: MW",y) = sum(gzmap(g,z), vCap.l(g,y)) +1e-6;
pPeakCapacity(z,"Peak demand: MW"       ,y) = smax((q,d,t), pDemandData(z,q,d,y,t)*pEnergyEfficiencyFactor(z,y)) +1e-6;
...
pPeakCapacity(z,"New capacity: MW"      ,y) = sum(gzmap(g,z), vBuild.l(g,y)) +1e-6;
pPeakCapacity(z,"Retired capacity: MW"  ,y) = sum(gzmap(g,z), vRetire.l(g,y)) +1e-6;
pPeakCapacity(z,"Committed Total TX capacity: MW"  ,y) = sum((z2,q), pTransferLimit(z,z2,q,y)/card(q)) +1e-6;

pCapacityByFuel(z,f,y)  = sum((gzmap(g,z),gprimf(g,f)), vCap.l(g,y)) +1e-6;
pCapacityByTechandFuel(z,tech,f,y)  = sum((gzmap(g,z),gtechmap(g,tech),gprimf(g,f)), vCap.l(g,y)) +1e-6;   
pNewCapacityFuel(z,f,y) = sum((gzmap(g,z),gprimf(g,f)), vBuild.l(g,y)) +1e-6;

pNewCapacityTech(z,tech,y)       = sum((gzmap(g,z),gtechmap(g,tech),gprimf(g,f)), vBuild.l(g,y)) +1e-6;
pRetirementsFuel(z,f,y)          = sum((gzmap(g,z),gprimf(g,f)),vRetire.l(g,y)) +1e-6;





pUtilizationByFuel(z,f,y)$(pCapacityByFuel(z,f,y)) = pEnergyByFuel(z,f,y)/(pCapacityByFuel(z,f,y) * pTotalHoursperYear(y))*1000 +1e-6;
pUtilizationByTechandFuel(z,tech,f,y)$(pCapacityByTechandFuel(z,tech,f,y)) = pEnergyByTechandFuel(z,tech,f,y)/(pCapacityByTechandFuel(z,tech,f,y) * pTotalHoursperYear(y))*1000 +1e-6;

* By Country
pPeakCapacityCountry(c,"Available capacity: MW",y) = sum(zcmap(z,c), pPeakCapacity(z,"Available capacity: MW",y)) +1e-6;
pPeakCapacityCountry(c,"Peak demand: MW"       ,y) = smax((q,d,t), sum(zcmap(z,c), pDemandData(z,q,d,y,t)*pEnergyEfficiencyFactor(z,y))) +1e-6;
pPeakCapacityCountry(c,"New capacity: MW"      ,y) = sum(zcmap(z,c), pPeakCapacity(z,"New capacity: MW",y)) +1e-6;
pPeakCapacityCountry(c,"Retired capacity: MW"  ,y) = sum(zcmap(z,c), pPeakCapacity(z,"Retired capacity: MW",y)) +1e-6;
pPeakCapacityCountry(c,"Committed Total TX capacity: MW",y) = sum(zcmap(z,c), pPeakCapacity(z,"Committed Total TX capacity: MW",y)) +1e-6;

pCapacityByFuelCountry(c,f,y)  = sum(zcmap(z,c), pCapacityByFuel(z,f,y)) +1e-6;
pCapacityByTechandFuelCountry(c,tech,f,y)  = sum(zcmap(z,c), pCapacityByTechandFuel(z,tech,f,y)) +1e-6;      
pNewCapacityFuelCountry(c,f,y) = sum(zcmap(z,c), pNewCapacityFuel(z,f,y)) +1e-6;

pNewCapacityTechCountry(c,tech,y)=sum(zcmap(z,c), pNewCapacityTech(z,tech,y)) +1e-6;

pCapacityPlanCountry(c,g,y)    = sum((zcmap(z,c),gzmap(g,z)), vCap.l(g,y)) +1e-6;
pUtilizationByFuelCountry(c,f,y)$(pCapacityByFuelCountry(c,f,y)) = pEnergyByFuelCountry(c,f,y)/(pCapacityByFuelCountry(c,f,y)* pTotalHoursperYear(y))*1000 +1e-6;
pUtilizationByTechandFuelCountry(c,tech,f,y)$(pCapacityByTechandFuelCountry(c,tech,f,y)) = pEnergyByTechandFuelCountry(c,tech,f,y)/(pCapacityByTechandFuelCountry(c,tech,f,y) * pTotalHoursperYear(y))*1000 +1e-6;

pRetirementsCountry(c,y)          = sum((zcmap(z,c),f),pRetirementsFuel(z,f,y)) +1e-6;
pRetirementsFuelCountry(c,f,y)      = sum(zcmap(z,c),pRetirementsFuel(z,f,y)) +1e-6;


* By Plant
pCapacityPlan(zgmap(z,g),y)                 = vCap.l(g,y)+0.00001;
pRetirements(zgmap(z,g),y)                  = vRetire.l(g,y) +1e-6;
pPlantUtilization(zgmap(z,g),y)$vCap.l(g,y) = sum((gfmap(g,f),q,d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/vCap.l(g,y)/8760+0.000001;
...
pReserveMarginRes(z,"Peak demand: MW",y) = smax((q,d,t), pDemandData(z,q,d,y,t)*pEnergyEfficiencyFactor(z,y))+1e-6;
pReserveMarginRes(z,"TotalFirmCapacity",y) = sum(zgmap(z,g), pCapacityCredit(g,y)* vCap.l(g,y))+1e-6;                  
pReserveMarginRes(z,"ReserveMargin",y)$(pReserveMarginRes(z,"TotalFirmCapacity",y)) = pReserveMarginRes(z,"TotalFirmCapacity",y)/pReserveMarginRes(z,"Peak demand: MW",y)  +1e-6;             



* By Country
pSpinningReserveCostsCountry(c,g,y)  =  sum((zcmap(z,c),zgmap(z,g)), pSpinningReserveCostsZone(z,g,y)) +1e-6;
pSpinningReserveByPlantCountry(c,g,y)=  sum((zcmap(z,c),zgmap(z,g)), pSpinningReserveByPlantZone(z,g,y)) +1e-6;
...
pReserveMarginResCountry(c,"ReserveMargin",y)$(pReserveMarginResCountry(c,"TotalFirmCapacity",y)) = pReserveMarginResCountry(c,"TotalFirmCapacity",y)/ pReserveMarginResCountry(c,"Peak demand: MW",y) +1e-6 ;   
...
*--- Emission Results
* By Zone
pEmissions(z,y)                                                     =  vZonalEmissions.l(z,y)/1e6 +1e-6;
pEmissionsIntensity(z,y)$pDemandSupply(z,"Total production: GWh",y) = 1e-3*vZonalEmissions.l(z,y)/pDemandSupply(z,"Total production: GWh",y)+1e-6;

pEmissionsCountry1(c,"Emissions: mm tCO2eq",y)                               = sum(zcmap(z,c), pEmissions(z,y)  )+1e-6;
pEmissionsCountry1(c,"CO2backstopEmissions: mm tCO2eq",y)                    = vYearlyCO2backstop.l(c,y)/1e6+1e-6;
pEmissionsIntensityCountry(c,y)$pDemandSupplyCountry(c,"Total production: GWh",y) = 1e-3*sum(zcmap(z,c), vZonalEmissions.l(z,y))/pDemandSupplyCountry(c,"Total production: GWh",y)+1e-6;

*--- Emission marginal costs
 
pEmissionMarginalCosts(y) $(pWeightYear(y))                  = -eTotalEmissionsConstraint.M(y)/pRR(y)/pWeightYear(y)+1e-6;
pEmissionMarginalCostsCountry(c,y) $(pWeightYear(y))         = -eEmissionsCountry.M(c,y)/pRR(y)/pWeightYear(y)+1e-6;  
...
*                 max(1,Sum((z,q,d,t),vImportPrice.l(z,q,d,t,y)*pHours(q,d,y,t))));
                       ...
                       )/sum(z, sum((zext,q,d,t), (vImportPrice.l(z,zext,q,d,t,y) - vExportPrice.l(z,zext,q,d,t,y))*pHours(q,d,y,t)) + pDenom2(z,y))+1e-6;
...
pZonalAverageCost(z,y)$pDenom2(z,y) = zctmp(z,y)/(sum((zext,q,d,t), (vImportPrice.l(z,zext,q,d,t,y) - vExportPrice.l(z,zext,q,d,t,y))*pHours(q,d,y,t))
                                                + sum((sTopology(Zd,z),q,d,t), vFlow.l(Zd,z,q,d,t,y)*pHours(q,d,y,t)) + pDenom2(z,y))+1e-6;
...
pCountryAverageCost(c,y)$pDenom3(c,y) = sum(zcmap(z,c), zctmp(z,y))/(sum((zcmap(z,c),zext,q,d,t), (vImportPrice.l(z,zext,q,d,t,y) - vExportPrice.l(z,zext,q,d,t,y))*pHours(q,d,y,t))
                                                                   + pDenom3(c,y)
                                                                   + sum((zcmap(z,c),sMapNCZ(Zd,z),q,d,t), vFlow.l(Zd,z,q,d,t,y)*pHours(q,d,y,t)))+1e-6;
...
pZonalAverageGenCost(z,y)$pDenom2(z,y) = zctmp(z,y)/pDenom2(z,y) +1e-6;
pCountryAverageGenCost(c,y)$pDenom3(c,y) = sum(zcmap(z,c),zctmp(z,y))/pDenom3(c,y)+1e-6;
...
pCostsbyPlant(zgmap(z,ndc), "Annuity Cost in MUSD",y)= (pCRF(ndc)*vCap.l(ndc,y)*pGenData(ndc,"Capex")*1e6
                                                 ...
                                                 + pCRFcth(ndc)*vCapTherm.l(ndc,y)*pCSPData(ndc,"Thermal Field","Capex")*1e6)/1e6 +1e-6;
                                                 
pCostsbyPlant(zgmap(z,dc), "Annuity Cost in MUSD",y)=   vAnnCapex.l(dc,y)/1e6 +1e-6;
...
pCostsbyPlant(zgmap(z,g),"Fixed Cost in MUSD",y)=       (  vCap.l(g,y)*pGenData(g,"FOMperMW")
                                                 ...
                                                 + vCapTherm.l(g,y)*pCSPData(g,"Thermal field","FixedOM"))/1e6 +1e-6;

pCostsbyPlant(zgmap(z,g),"Variable Cost in MUSD",y)= sum((gfmap(g,f),q,d,t), pVarCost(g,f,y)*vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e6 +1e-6;
pCostsbyPlant(zgmap(z,g),"Spinning Reserve Cost in MUSD",y)= pSpinningReserveCostsZone(z,g,y) +1e-6;
pCostsbyPlant(zgmap(z,g),"Capacity Factor",y)= pPlantUtilization(z,g,y) +1e-6;
...
pStorageBalance(y,stg,q,d,"Storage Input"     ,t) = vStorInj.l(stg,q,d,t,y) +1e-6;
pStorageBalance(y,stg,q,d,"Storage Output"    ,t) = sum(gfmap(stg,f), vPwrOut.l(stg,f,q,d,t,y)) +1e-6;
pStorageBalance(y,stg,q,d,"Storage Losses"    ,t) = (1-pStorData(stg,"efficiency"))*vStorInj.l(stg,q,d,t,y) +1e-6;
pStorageBalance(y,stg,q,d,"Net Storage Change",t) = vStorNet.l(stg,q,d,t,y) +1e-6;
pStorageBalance(y,stg,q,d,"Storage Level"     ,t) = vStorage.l(stg,q,d,t,y) +1e-6;

pStorageComponents(stg,"Storage Capacity in MW",y) = vCap.l(stg,y) +1e-6;
pStorageComponents(stg,"Storage Capacity MWh"  ,y) = vCapStor.l(stg,y) +1e-6;
pStorageComponents(stg,"Storage Hours"         ,y) = vCapStor.l(stg,y)/max(vCap.l(stg,y),1) +1e-6;
...
pDemandSupplySeason(z,"Demand: GWh"            ,y,q) = sum((d,t), pDemandData(z,q,d,y,t)*pHours(q,d,y,t)*pEnergyEfficiencyFactor(z,y))/1e3 +1e-6;
pDemandSupplySeason(z,"Total production: GWh"  ,y,q) = sum((zgmap(z,g),gfmap(g,f),d,t), vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;
pDemandSupplySeason(z,"Unmet demand: GWh"      ,y,q) = sum((d,t), vUSE.l(z,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;
pDemandSupplySeason(z,"Surplus generation: GWh",y,q) = sum((d,t), vSurplus.l(z,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;

pDemandSupplySeason(z,"Imports exchange: GWh",y,q) = (sum((sTopology(z,z2),d,t), vFlow.l(z2,z,q,d,t,y)*pHours(q,d,y,t)) + sum((zext,d,t), vImportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;
pDemandSupplySeason(z,"Exports exchange: GWh",y,q) = (sum((sTopology(z,z2),d,t), vFlow.l(z,z2,q,d,t,y)*pHours(q,d,y,t)) + sum((zext,d,t), vExportPrice.l(z,zext,q,d,t,y)*pHours(q,d,y,t)))/1e3 +1e-6;

* B. Seasonal Energy by Plant
pEnergyByPlantSeason(zgmap(z,g),y,q) = sum((gfmap(g,f),d,t),vPwrOut.l(g,f,q,d,t,y)*pHours(q,d,y,t))/1e3 +1e-6;
...
**********************************************************Dispatch********************************************
pUnmetP, pFuelDispatch,  pDemandTotalP, pCurtailedVRET, pPlantDispatch2, pStorInj     ,pStorOut  ,pStorLevel,pStorInjG,pStorOutG  ,pStorLevelG,pDemandShed,pSpinReserves,pH2PwrInT
pOn, pStUp, pShDn
pStUpCostG
...
**************************************Dispatch******************************
  par=pStorInj         rDim=4 cDim=1     rng=StorageOper!A6
  par=pStorOut         rDim=4 cDim=1     rng=StorageOper!H6
  par=pStorLevel       rDim=4 cDim=1     rng=StorageOper!N6
  par=pDemandTotalP    rDim=4 cDim=1     rng=PowerDemand!A5   
  par=pFuelDispatch    rdim=4 cDim=2     rng=FuelDispath!A6
  par=pUnmetP          rDim=4 cDim=1     rng=UnmetDemandP!a6
  par=pPlantDispatch2  rdim=4 cDim=2     rng=PlantDispatch2!A5 
  par=pCurtailedVRET   rDim=4 cDim=1     rng=CurtVRET!A5
  par=pDemandShed      rDim=4 cDim=1     rng=DemandResponse!A5
  par=pSpinReserves      rDim=4 cDim=2     rng=SpinReserveG!A5  

  par=pH2PwrInT        rDim=4 cDim=1     rng=Power2H2!A5  


  par=pOn              rDim=5 cDim=2     rng=OnDecisions!A6
  par=pStUp            rDim=5 cDim=2     rng=StUpDecisions!A6
  par=pShDn            rDim=5 cDim=2     rng=ShDnDecisions!A6
  par=pStUpCostG       rDim=4 cDim=2     rng=StUpCostPerGen!A6
  ...
  par=pStorInjG         rDim=4 cDim=2     rng=StorageOperG!A6
  par=pStorOutG         rDim=4 cDim=2     rng=StorageOperG!I6
  par=pStorLevelG       rDim=4 cDim=2     rng=StorageOperG!Q6
...
Capacity("Capacity MW",f,y) =  Sum(gprimf(g,f), vCap.l(g,y)) +1e-6;
CapacityMIRO(f,y) = Capacity("Capacity MW",f,y);

CapacitySummary(" ","Peak"               ,y) = smax(c, pPeakCapacityCountry(c,"Peak demand: MW",y)) +1e-6;
CapacitySummary(" ","New capacity MW"    ,y) = sum(g, vBuild.l(g,y)) +1e-6;
CapacitySummary(" ","Retired capacity MW",y) = sum(g, vRetire.l(g,y)) +1e-6;
...
Energy("Energy GWh",f,y) = sum(c, pEnergyByFuelCountry(c,f,y)) +1e-6;
EnergyMIRO(f,y) = Energy("Energy GWh",f,y);

Costs("Costs","Capex: $m"       ,y)= sum(z, pCapex(z,y))/1e6 +1e-6;
Costs("Costs","Fixed O&M: $m"   ,y)= sum(z, pFOM(z,y))/1e6 +1e-6;
Costs("Costs","Variable O&M: $m",y)= sum(z, pVOM(z,y))/1e6 +1e-6;

Costs("Costs","Total fuel: $m"  ,y)= sum(z, pFuelCostsZone(z,y))/1e6 +1e-6;

Costs("Costs","Net Import: $m"  ,y)= sum(z, pImportCosts(z,y) - pExportRevenue(z,y))/1e6 +1e-6;
...
Utilization("Utilization",f,y)$Capacity("Capacity MW",f,y) = Energy("Energy GWh",f,y)/Capacity("Capacity MW",f,y) +1e-6;
