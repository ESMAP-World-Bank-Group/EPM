...
$set BASE_FILE "WB_EPM_v8_5_base_stochastic.gms"
$endIf
...
$set REPORT_FILE "WB_EPM_v8_5_report_stochastic.gms"
$endIf
$log REPORT_FILE is "%REPORT_FILE%"


$ifThen not set READER_FILE
$set READER_FILE "WB_EPM_input_readers_use_case.gms"
$endIf
...
$load pMaxFuellimit pTransferLimit pLossFactor pVREProfile pVREgenProfile
$load pAvailability
...
display  tech, hh, pH2DataExcel,g, pFuelData,  pDemandData, pExternalH2, zext;
display pExtTransferLimit, pTradePrice;
...
pCapacityCredit(ROR,y) =  sum((q,s),pAvailability(ROR,s,q)*pProbaScenarios(s)*sum((d,t),pHours(q,d,t)))/sum((q,d,t),pHours(q,d,t))   ;
...
sExportPrice(z,zext,q,d,t,y,s)$(pallowExports) = yes;
sImportPrice(z,zext,q,d,t,y,s)$(pallowExports) = yes;

sExportPrice(z,zext,q,d,t,y,s)$(not pallowExports) = no;
sImportPrice(z,zext,q,d,t,y,s)$(not pallowExports) = no;

vImportPrice.up(z,zext,q,d,t,y,s)$pallowExports = pExtTransferLimitIn(z,zext,q,y);
vExportPrice.up(z,zext,q,d,t,y,s)$pallowExports = pExtTransferLimitOut(z,zext,q,y);

* Do not allow imports and exports for a zone without import/export prices
sExportPrice(z,zext,q,d,t,y,s)$(pTradePrice(zext,q,d,y,t)= 0) = no;
sImportPrice(z,zext,q,d,t,y,s)$(pTradePrice(zext,q,d,y,t)= 0) = no;
...
sSpinningReserve(g,q,d,t,y,s) = yes;
sSpinningReserve(g,q,d,t,y,s)$(not (pzonal_spinning_reserve_constraints or psystem_spinning_reserve_constraints) ) = no;
