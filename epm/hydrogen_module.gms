...
Positive Variables
   ...
   vREPwr2H2(re,f,q,d,t,y)      'Generation from RE generators that goes to H2 production'
   vREPwr2Grid(re,f,q,d,t,y)   'Generation from VRE generators that goes to the grid'
