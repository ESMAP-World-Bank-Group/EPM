...
Sets
   ...
   sExportPrice(z,q,d,t,y)     'valid tuples for vExportPrice'
   sImportPrice(z,q,d,t,y)     'valid tuples for vImportPrice'
...
Positive Variables
   ...
   vImportPrice(z,q,d,t,y)   'external price driven import'
   vExportPrice(z,q,d,t,y)   'external price driven export'
   ...
   vCurtailedVRE(z,g,q,d,t,y)         'Curtailed power in MW'
...
Equations
   ...
   eMaxImportPrice(c,y)            'import limits'
...
eYearlyReserveCost(z,y)..
   vYearlyReserveCost(z,y) =e= sum((gzmap(g,z),q,d,t), vReserve(g,q,d,t,y)*pGenData(g,"ReserveCost")*pHours(q,d,t));
...
eYearlyTradeCost(z,y)..
   vYearlyTradeCost(z,y) =e= sum((q,d,t), vImportPrice(z,q,d,t,y)*pTradePrice(z,q,d,y,t)*pHours(q,d,t))
                           - sum((q,d,t), vExportPrice(z,q,d,t,y)*pTradePrice(z,q,d,y,t)*pHours(q,d,t));

eYearlyUSRCost(c,y)..
   vYearlyUSRCost(c,y) =e= vUnmetReserve(c,y)*pReserveVoLL
                         + sum((q,d,t), vUnmetSpinLoc(c,q,d,t,y)*pHours(q,d,t)*pSpinReserveVoLL);
...
eYearlySysUSRCost(y)..
   vYearlySysUSRCost(y) =e= vUnmetSysReserve(y)*pReserveVoLL
                          + sum((q,d,t), vUnmetSpin(q,d,t,y)*pHours(q,d,t)*pSpinReserveVoLL);
...
*                                                        + sum(gzmap(st,z), vStorOut(st,q,d,t,y))
                                                         ...
                                                         + vImportPrice(z,q,d,t,y)
                                                         - vExportPrice(z,q,d,t,y)
                                                         + vUSE(z,q,d,t,y)
                                                         - vSurplus(z,q,d,t,y)
...
eMaxImportPrice(c,y)..
   sum((zcmap(z,c),q,d,t), vImportPrice(z,q,d,t,y)*pHours(q,d,t)) =l=
   sum((zcmap(z,c),q,d,t), pDemandData(z,q,d,y,t)*pHours(q,d,t)*pEnergyEfficiencyFactor(z,y))*pMaxPriceImportShare(y,c);

eMaxhourlyImportsshare(c,q,d,t,y)$(pMaxImport<1)..
   sum(zcmap(z,c), vImportPrice(z,q,d,t,y))  =l= sum(zcmap(z,c), pDemandData(z,q,d,y,t)*pMaxImport);

eMaxhourlyExportsshare(c,q,d,t,y)$(pMaxExport<1)..
   sum(zcmap(z,c), vExportPrice(z,q,d,t,y)) =l= sum(zcmap(z,c), pDemandData(z,q,d,y,t)*pMaxExport);
...
eMinGen(g,q,d,t,y)$(Relevant(d) and pmingen_constraints and pGenData(g,"MinLimitShare") > 0 and (sum(z, pDemandData(z,q,d,y,t)) >0 ))..
...
*                                - vFlow(z2,z,q,d,t,y))
   =g= pReserveReqLoc(c,y) + sum((zcmap(z,c),gzmap(VRE,z),gfmap(VRE,f)), vPwrOut(VRE,f,q,d,t,y))*0.15 ;

eResReqSystem(q,d,t,y)$psystem_spinning_reserve_constraints..
   sum(g, vReserve(g,q,d,t,y)) + vUnmetSpin(q,d,t,y) =g= pReserveReqSys(y) + sum(gfmap(VRE,f), vPwrOut(VRE,f,q,d,t,y))*0.15;
...
eEmissionsCountry(c,y)$pzonal_co2_constraints..
   sum(zcmap(z,c), vZonalEmissions(z,y))-vYearlyCO2backstop(c,y)=l= pEmissionsZone(c,y);
