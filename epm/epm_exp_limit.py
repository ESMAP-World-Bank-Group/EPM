...
PATH_GAMS = {
    'path_main_file': 'main_exp_limit.gms',
    'path_base_file': 'base_exp_limit.gms',
...
def launch_epm_checkpoint(scenario,
    ...
    os.chdir(new_dir)
    model_path, model_directory =  os.path.join(new_dir, 'main_exp_limit.gms'), new_dir # Get the paths
...
def launch_epm(scenario,
    ...
    if path_engine_file:
        # Open Engine_base_exp_limit.gms as text file and replace
