...
$offExternalOutput
   ...
   pFOM(z,y)                                 'FOM in USD'
   pVOM(z,y)                                 'VOM  in USD'
   pVOMScenarios(z,y,s)                                 'VOM  in USD'
   ...
   pFuelDispatchScenarios(z,q,d,t,y,f,s)                 'Detailed Dispatch by fuel'
...
pVOMScenarios(z,y,s) = sum((q,d,t), pHours(q,d,t)*(
...
pVOM(z,y) = sum(s, pVOMScenarios(z,y,s) * pProbaScenarios(s));

pFuelCostsZone(z,y) = sum((gzmap(g,z),gfmap(g,f),zcmap(z,c),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)* pProbaScenarios(s)*pHours(q,d,t)*pFuelPrice(c,f,y)*pHeatRate(g,f));


pImportCosts(z,y) = sum((zext,q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pTradePrice(zext,q,d,y,t)*pHours(q,d,t));

pExportRevenue(z,y) = sum((zext,q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pTradePrice(zext,q,d,y,t)*pHours(q,d,t));

pNewTransmissionCosts(z,y) = vYearlyTransmissionAdditions.l(z,y);
pUSECosts(z,y) = vYearlyUSECost.l(z,y);
pCO2backstopCosts(c,y) = sum(s, vYearlyCO2backstop.l(c,y,s)*pCostOfCO2backstop*pProbaScenarios(s));
pSurplusCosts(z,y) = vYearlySurplus.l(z,y);
pVRECurtailment(z,y) = vYearlyCurtailmentCost.l(z,y);
        

* country level
pCountryPlanReserveCosts(c,y) = sum(s, vUnmetPlanningReserveCountry.l(c,y,s)*pProbaScenarios(s)*pPlanningReserveVoLL);
pUSRLocCosts(c,y) = sum((q,d,t,s), vUnmetSpinningReserveCountry.l(c,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)*pSpinningReserveVoLL);

* System level
pUSRSysCosts(y) = sum((q,d,t,s), vUnmetSpinningReserveSystem.l(q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)*pSpinningReserveVoLL);
...
* By zone
pFuelCosts(z,f,y) = sum((gzmap(g,z),gfmap(g,f),zcmap(z,c),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)*pFuelPrice(c,f,y)*pHeatRate(g,f))/1e6;
pFuelConsumption(z,f,y) = sum(s, vFuel.l(z,f,y,s)*pProbaScenarios(s)/1e6);
...
pEnergyByFuel(z,f,y) = sum((gzmap(g,z),gfmap(g,f),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pEnergyByFuelCountry(c,f,y) = sum(zcmap(z,c), pEnergyByFuel(z,f,y));
pEnergyByTechandFuel(z,tech,f,y) = sum((gzmap(g,z),gtechmap(g,tech),gfmap(g,f),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
pEnergyByPlant(zgmap(z,g),y) = sum((gfmap(g,f),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
pDemandSupply(z,"Unmet demand: GWh"      ,y) = sum((q,d,t,s), vUSE.l(z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pDemandSupply(z,"Surplus generation: GWh",y) = sum((q,d,t,s), vSurplus.l(z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;

pDemandSupply(z,"Imports exchange: GWh"     ,y) = (sum((sTopology(z,z2),q,d,t,s), vFlow.l(z2,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zext,q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;
pDemandSupply(z,"Exports exchange: GWh"     ,y) = (sum((sTopology(z,z2),q,d,t,s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zext,q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;
...
pDemandSupplyCountry(c,"Imports exchange: GWh"     ,y) = (sum((zcmap(z,c),sMapNCZ(z2,z),q,d,t,s), vFlow.l(z2,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zcmap(z,c),zext,q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;
pDemandSupplyCountry(c,"Exports exchange: GWh"     ,y) = (sum((zcmap(z,c),sMapNCZ(z,z2),q,d,t,s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zcmap(z,c),zext,q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;
...
pSummary("Total Emission: mt"              ) = sum((z,y,s), pWeightYear(y)*vZonalEmissions.l(z,y,s)*pProbaScenarios(s))/1e6;
pSummary("Climate backstop cost: $m"       ) = sum((c,y,s), pWeightYear(y)*pRR(y)*vYearlyCO2backstop.l(c,y,s)*pProbaScenarios(s)*pCostOfCO2backstop)/1e6+sum((y,s), pWeightYear(y)*pRR(y)*pCostOfCO2backstop*vYearlySysCO2backstop.l(y,s)*pProbaScenarios(s))/1e6;
...
* By zone
pInterchange(sTopology(z,z2),y) = sum((q,d,t,s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
pLossesTransmission(z,y) = sum((sTopology(z,z2),q,d,t,s), vFlow.l(z2,z,q,d,t,y,s)*pProbaScenarios(s)*pLossFactor(z,z2,y)*pHours(q,d,t));
...
pHourlyTrade(z,y,q,d,"Imports",t) =   sum((zext,s),vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)); 
pHourlyTrade(z,y,q,d,"Exports",t) =   sum((zext,s),vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)); 
pYearlyTrade(z,thrd,y) = sum((q,d,t), pHourlyTrade(z,y,q,d,thrd,t)*pHours(q,d,t))/1e3;
pInterchangeExtExp(z,zext,y) = sum((q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
pInterchangeExtImp(zext,z,y) = sum((q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
pPrice(z,q,d,t,y)$(pHours(q,d,t)) = -sum(s, eDemSupply.m(z,q,d,t,y,s)*pProbaScenarios(s))/pHours(q,d,t)/pRR(y)/pWeightYear(y);
...
pAveragePriceExp(z,y) $(sum(Zd, zzFlowpH(z,Zd,y))  > 0) = (sum((sTopology(z,Zd),q,d,t,s),  pPrice(z,q,d,t,y) *vFlow.l(z,Zd,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
                                                           + sum((zext,q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s) * pHours(q,d,t))) 
                                                         /(sum(Zd, zzFlowpH(z,Zd,y))+ sum((zext,q,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)* pHours(q,d,t)));
pAveragePriceImp(z,y) $(sum(Zd, zzFlowpH(Zd,z,y))  > 0) = (sum((sTopology(Zd,z),q,d,t,s),  pPrice(Zd,q,d,t,y)*vFlow.l(Zd,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
                                                            + sum((zext,q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)* pTradePrice(zext,q,d,y,t)  * pHours(q,d,t))) 
                                                         /(sum(Zd, zzFlowpH(Zd,z,y))+ sum((zext,q,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)  * pHours(q,d,t)));
...
pAveragePriceExpCountry(c,y)$(cFlowpH(c,y) > 0) = sum((zcmap(z,c),sMapNCZ(z,Zd),q,d,t,s), pPrice(z,q,d,t,y)* vFlow.l(z,Zd,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
                                                 /cFlowpH(c,y);
cFlowpH(c,y) = sum((zcmap(z,c),sMapNCZ(Zd,z)), zzFlowpH(Zd,z,y));
pAveragePriceImpCountry(c,y)$(cFlowpH(c,y) > 0) = sum((zcmap(z,c),sMapNCZ(Zd,z),q,d,t,s), pPrice(Zd,q,d,t,y)*vFlow.l(Zd,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
                                                 /cFlowpH(c,y);
...
pPlantUtilization(zgmap(z,g),y)$vCap.l(g,y) = sum((gfmap(g,f),q,d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/vCap.l(g,y)/8760;
pPlantUtilizationTech(z,tech,y)$sum((zgmap(z,g),gfmap(g,f),gtechmap(g,tech))$vCap.l(g,y),vCap.l(g,y)) = sum((zgmap(z,g),gfmap(g,f),gtechmap(g,tech),q,d,t,s)$vCap.l(g,y), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
...
*--- Reserve Results
* By Zone
pSpinningReserveCostsZone(zgmap(z,g),y)   = sum((q,d,t,s), vSpinningReserve.l(g,q,d,t,y,s)*pProbaScenarios(s)*pGenData(g,"ReserveCost")*pHours(q,d,t))/1e6 ;
pSpinningReserveByPlantZone(zgmap(z,g),y) = sum((q,d,t,s), vSpinningReserve.l(g,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3 ;
...
*--- Emission Results
* By Zone
pEmissions(z,y)                                                     =  sum(s, vZonalEmissions.l(z,y,s)*pProbaScenarios(s)/1e6) ;
pEmissionsIntensity(z,y)$pDemandSupply(z,"Total production: GWh",y) = 1e-3*sum(s, vZonalEmissions.l(z,y,s)*pProbaScenarios(s))/pDemandSupply(z,"Total production: GWh",y);

pEmissionsCountry1(c,"Emissions: mm tCO2eq",y)                               = sum(zcmap(z,c), pEmissions(z,y)  );
pEmissionsCountry1(c,"CO2backstopEmissions: mm tCO2eq",y)                    = sum(s, vYearlyCO2backstop.l(c,y,s)*pProbaScenarios(s)/1e6);
pEmissionsIntensityCountry(c,y)$pDemandSupplyCountry(c,"Total production: GWh",y) = 1e-3*sum((zcmap(z,c),s), vZonalEmissions.l(z,y,s)*pProbaScenarios(s))/pDemandSupplyCountry(c,"Total production: GWh",y);

*--- Emission marginal costs
 
pEmissionMarginalCosts(y) $(pWeightYear(y))                  = -sum(s, eTotalEmissionsConstraint.M(y,s)*pProbaScenarios(s))/pRR(y)/pWeightYear(y);
pEmissionMarginalCostsCountry(c,y) $(pWeightYear(y))         = -sum(s, eEmissionsCountry.M(c,y,s)*pProbaScenarios(s))/pRR(y)/pWeightYear(y);  


*--- Solar Energy (zonal results)
set PVtech(tech) / PV, PVwSTO /;
Parameter zSolar(z,y), zSolarpH(z,y);
pSolarEnergy(z,q,d,t,y) = sum((gzmap(g,z),gtechmap(g,PVtech),gfmap(g,f),s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s));
...
pPlantDispatch(z,y,q,d,g,t,"Generation")$zgmap(z,g) = sum((gfmap(g,f),s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s));
pPlantDispatch(z,y,q,d,g,t,"Reserve")$zgmap(z,g) = sum(s, vSpinningReserve.l(g,q,d,t,y,s)*pProbaScenarios(s));


pDispatch(z,y,q,d,"Generation"    ,t) = sum(zgmap(z,g), pPlantDispatch(z,y,q,d,g,t,"Generation")); 
pDispatch(z,y,q,d,"Imports"       ,t) =      sum((sTopology(z,z2),s), vFlow.l(z2,z,q,d,t,y,s)*pProbaScenarios(s)) + sum((zext,s),vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s));
pDispatch(z,y,q,d,"Exports"       ,t) = 0 - (sum((sTopology(z,z2),s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)) + sum((zext,s),vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)));
pDispatch(z,y,q,d,"Unmet demand"  ,t) = sum(s, vUSE.l(z,q,d,t,y,s)*pProbaScenarios(s));
pDispatch(z,y,q,d,"Storage Charge",t) = 0 - sum((zgmap(z,st),s), vStorInj.l(st,q,d,t,y,s)*pProbaScenarios(s));
...
pFuelDispatchScenarios(z,q,d,t,y,f,s)  =sum(gfmap(g,f)$(gzmap(g,z)), vPwrOut.l(g,f,q,d,t,y,s));
...
pSystemAverageCost(y)$sum(z, pDenom2(z,y)) =
                        (sum((z,zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s)-vExportPrice.l(z,zext,q,d,t,y,s))*pProbaScenarios(s)*pTradePrice(zext,q,d,y,t)*pHours(q,d,t))
*                 max(1,Sum((z,q,d,t),vImportPrice.l(z,q,d,t,y)*pHours(q,d,t))));
                       ...
                       )/sum(z, sum((zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s) - vExportPrice.l(z,zext,q,d,t,y,s))*pProbaScenarios(s)*pHours(q,d,t)) + pDenom2(z,y));
...
pPlantAnnualLCOE(zgmap(z,ndc),y)$pDenom(z,ndc,y) = (pCRF(ndc)*vCap.l(ndc,y)*pGenData(ndc,"Capex")*1e6
                                                  ...
                                                  + sum((gfmap(ndc,f),q,d,t,s), pVarCost(ndc,f,y)*vPwrOut.l(ndc,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
...
pPlantAnnualLCOE(zgmap(z,dc),y)$pDenom(z,dc,y) =  (vAnnCapex.l(dc,y)
                                                 ...
                                                 + sum((gfmap(dc,f),q,d,t,s), pVarCost(dc,f,y)*vPwrOut.l(dc,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
*                                                + sum((q,d,t)$(gfmap(g,f)),  vSpinningReserve(g,q,d,t,y)*pGenData(g,"ReserveCost")*pHours(q,d,t))
                                                  )/pDenom(z,dc,y);


parameter zctmp(z,y);
zctmp(z,y) = sum((zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s) - vExportPrice.l(z,zext,q,d,t,y,s))*pTradePrice(zext,q,d,y,t)**pProbaScenarios(s)*pHours(q,d,t))
           + sum((sTopology(Zd,z),q,d,t,s), pPrice(Zd,q,d,t,y)*vFlow.l(Zd,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))
...
pZonalAverageCost(z,y)$pDenom2(z,y) = zctmp(z,y)/(sum((zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s) - vExportPrice.l(z,zext,q,d,t,y,s))*pProbaScenarios(s)*pHours(q,d,t))
                                                + sum((sTopology(Zd,z),q,d,t,s), vFlow.l(Zd,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + pDenom2(z,y));

pCountryAverageCost(c,y)$pDenom3(c,y) = sum(zcmap(z,c), zctmp(z,y))/(sum((zcmap(z,c),zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s) - vExportPrice.l(z,zext,q,d,t,y,s))*pProbaScenarios(s)*pHours(q,d,t))
                                                                   + pDenom3(c,y)
                                                                   + sum((zcmap(z,c),sMapNCZ(Zd,z),q,d,t,s), vFlow.l(Zd,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)));
...
pCostsbyPlant(zgmap(z,g),"Variable Cost in MUSD",y)= sum((gfmap(g,f),q,d,t,s), pVarCost(g,f,y)*vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e6;
...
*---  CSP and storage
pCSPBalance(y, g,q,d,"Thermal output",t) = sum(s, vThermalOut.l(g,q,d,t,y,s)*pProbaScenarios(s));
pCSPBalance(y,cs,q,d,"Storage Input" ,t) = sum(s, vStorInj.l(cs,q,d,t,y,s)*pProbaScenarios(s));
pCSPBalance(y,cs,q,d,"Storage Output",t) = sum(s, vStorOut.l(cs,q,d,t,y,s)*pProbaScenarios(s));
pCSPBalance(y,cs,q,d,"Power Output"  ,t) = sum((gfmap(cs,f),s), vPwrOut.l(cs,f,q,d,t,y,s));
...
pPVwSTOBalance(y,q,d,so, "PV output"     ,t) = sum((gfmap(so,f),s), vPwrOut.l(so,f,q,d,t,y,s));
pPVwSTOBalance(y,q,d,stp,"Storage Input" ,t) = sum(s, vStorInj.l(stp,q,d,t,y,s)*pProbaScenarios(s));
pPVwSTOBalance(y,q,d,stp,"Storage output",t) = sum((gfmap(stp,f),s), vPwrOut.l(stp,f,q,d,t,y,s)*pProbaScenarios(s));
pPVwSTOBalance(y,q,d,stp,"Storage Losses",t) = sum(s, (1-pStorData(stp,"efficiency"))*vStorInj.l(stp,q,d,t,y,s)*pProbaScenarios(s));
pPVwSTOBalance(y,q,d,stp,"Storage level" ,t) = sum(s, vStorage.l(stp,q,d,t,y,s)*pProbaScenarios(s));
...
pStorageBalance(y,stg,q,d,"Storage Input"     ,t) = sum(s, vStorInj.l(stg,q,d,t,y,s)*pProbaScenarios(s));
pStorageBalance(y,stg,q,d,"Storage Output"    ,t) = sum((gfmap(stg,f),s), vPwrOut.l(stg,f,q,d,t,y,s)*pProbaScenarios(s));
pStorageBalance(y,stg,q,d,"Storage Losses"    ,t) = sum(s,(1-pStorData(stg,"efficiency"))*vStorInj.l(stg,q,d,t,y,s)*pProbaScenarios(s));
pStorageBalance(y,stg,q,d,"Net Storage Change",t) = sum(s, vStorNet.l(stg,q,d,t,y,s)*pProbaScenarios(s));
pStorageBalance(y,stg,q,d,"Storage Level"     ,t) = sum(s, vStorage.l(stg,q,d,t,y,s)*pProbaScenarios(s));
...
pDemandSupplySeason(z,"Total production: GWh"  ,y,q) = sum((zgmap(z,g),gfmap(g,f),d,t,s), vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pDemandSupplySeason(z,"Unmet demand: GWh"      ,y,q) = sum((d,t,s), vUSE.l(z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pDemandSupplySeason(z,"Surplus generation: GWh",y,q) = sum((d,t,s), vSurplus.l(z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;

pDemandSupplySeason(z,"Imports exchange: GWh",y,q) = (sum((sTopology(z,z2),d,t,s), vFlow.l(z2,z,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zext,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;
pDemandSupplySeason(z,"Exports exchange: GWh",y,q) = (sum((sTopology(z,z2),d,t,s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)) + sum((zext,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t)))/1e3;

* B. Seasonal Energy by Plant
pEnergyByPlantSeason(zgmap(z,g),y,q) = sum((gfmap(g,f),d,t,s),vPwrOut.l(g,f,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;


* C.Interchange

* By Zone
pInterchangeSeason(sTopology(z,z2),y,q) = sum((d,t,s), vFlow.l(z,z2,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pSeasonTrade(z,"External Zone Imports",y,q) = sum((zext,d,t,s), vImportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
pSeasonTrade(z,"External Zone Exports",y,q) = sum((zext,d,t,s), vExportPrice.l(z,zext,q,d,t,y,s)*pProbaScenarios(s)*pHours(q,d,t))/1e3;
...
execute_unload 'epmresults',     pScalars, pSummary, pSystemAverageCost, pZonalAverageCost,pCountryAverageCost
                                 ...
                                 pFuelDispatch, pEnergyByPlant, pEnergyByFuel,pEnergyByFuelCountry, pEnergyByTechandFuel,pEnergyByTechandFuelCountry,pEnergyMix,
...
AverageCost(" ","Average cost $/MWh",y) = (sum(ndc, pCRF(ndc)*vCap.l(ndc,y)*pGenData(ndc,"Capex"))*1e6
                                         ...
                                         + sum(z, pFOM(z,y) + pVOM(z,y) + pSpinResCosts(z,y) + pFuelCostsZone(z,y))
                                          )/sum(z, sum((zext,q,d,t,s), (vImportPrice.l(z,zext,q,d,t,y,s)-vExportPrice.l(z,zext,q,d,t,y,s))*pProbaScenarios(s)*pHours(q,d,t))
                                                 + pDenom2(z,y));
